#dpdlMIDPUI.h V1.0      info@seesolutions.it
#
#Author: Armin Costa
#
...
#License: GNU GPL
#
#This library provides basic a basic interaction layer for accessing MIDP UI functiontions
#
function calendarGet(int field_name)
     return MIDPLIB_getCalendarField(field_name)
end

#return int status == 1 if display  activated else 0
function Alert(string title, string msg, int type)
      return MIDPLIB_Alert(title, msg, type)
end

#return int component id
function Form(int instance, string title)
      return MIDPLIB_Form(instance, title)
end

#return int status
function FormAppend(int component, string text)
    return MIDPLIB_FormAppend(component, text)
end

#return int status
function FormClear(int component)
     return MIDPLIB_FormClear(component)
end

#return int component id
function Canvas(int instance)
